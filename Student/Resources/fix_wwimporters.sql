...
ALTER TABLE [Sales].[CustomerTransactions] drop CONSTRAINT [PK_Sales_CustomerTransactions]
GO

ALTER TABLE [Sales].[CustomerTransactions] ADD  CONSTRAINT [PK_Sales_CustomerTransactions] PRIMARY KEY NONCLUSTERED 
(
	[CustomerTransactionID],[TransactionDate] ASC
)
GO

ALTER TABLE [Purchasing].[SupplierTransactions] DROP  CONSTRAINT [PK_Purchasing_SupplierTransactions]
GO

ALTER TABLE [Purchasing].[SupplierTransactions] ADD  CONSTRAINT [PK_Purchasing_SupplierTransactions] PRIMARY KEY NONCLUSTERED 
(
	[SupplierTransactionID],[TransactionDate] ASC
)
GO
...
-- RUN this on your Azure SQL after migration is completed
